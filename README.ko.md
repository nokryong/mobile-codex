...
**0.1.18 alpha** · **ARM64 / Android 10 이상** · 제작 [nokryong](https://github.com/nokryong)
...
| Actions 산출물 | 용도 |
| --- | --- |
| **`mobile-codex-update-assets`** | **설치할 때 받을 파일.** ZIP을 풀면 `mobile-codex-0.1.18-alpha-arm64.apk`와 검증 파일이 나옵니다. |
