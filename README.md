...
**0.1.14 alpha** · **ARM64 / Android 10+** · Created by [nokryong](https://github.com/nokryong)
...
Open [Releases](https://github.com/nokryong/mobile-codex/releases) and download **`mobile-codex-0.1.14-alpha-arm64.apk`** from the release assets. Open the APK and follow Android’s installation prompts. If requested, allow installation from the app you used to download/open it.
